 ...
 */
	...
	public static void testRegisterUser() throws ParseException {
		try {
			...
			bean.setFirstName("Nidhi Mishra");
			bean.setLastName("");
			bean.setLogIn("Nidhi Mishra448@gmail.com");
			bean.setPassword("Nidhi Mishra@1997");
			bean.setConfirmPassword("Nidhi Mishra@1997");
...
//			}
	...
	public static void testFindByLogin() {
		try {
			UserBean bean = new UserBean();
			bean = model.findByLogin("Nidhi Mishra448@gmail.com");
			if (bean == null) {
